...
class MovingAverage1( DailyBookListener ):
    ...
    def get_unique_instance( identifier, _startdate, _enddate, _config):
        if identifier not in MovingAverage1.instances.keys() :
            new_instance = MovingAverage1( identifier, _startdate, _enddate, _config )
            MovingAverage1.instances[identifier] = new_instance
        return MovingAverage1.instances[identifier]
