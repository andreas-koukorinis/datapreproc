...
python daily_update.py f-indices 1 XMSW ^AXJO ^BSES ^BVSP ^FTSE ^GDAX ^GU15 ^MXX ^N500 ^N150 ^NZ50 ^SSMI ^XMSC >> log
python daily_update.py indices 1 VIX TCMP SPX NYA COMP >> log