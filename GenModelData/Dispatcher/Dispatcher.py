...
'''The job of the dispatcher is :
 ...
 Listeners : OnDailyEventUpdate -> BookBuilders 
 ...
 3)Push the next events into the heap and repeat'''
    ...
    def heap_initialize(self,products):
        ...
        for _product in self.products:
            ...
            try:
                ...
                _query = "SELECT Date," + _product.lstrip('f') + ",Spec FROM " + _table_name + " WHERE Date >= '" + str(self.sim_start_dt.date())+"' AND Date <= '" + str( ( self.end_dt ).date() ) + "' ORDER BY Date";
