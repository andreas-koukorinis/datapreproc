...
class TargetRiskVolatilityParity(SignalAlgorithm):
    ...
    def init(self, _config):
        ...
        self.last_date_correlation_matrix_computed = -self.correlation_computation_interval # So that even if the rebalance frequency is very high, we should trade on the first day
        self.last_date_stdev_computed = -self.stdev_computation_interval
